...
<div class="col-xl-8 px-md-5">
    <h3 style="margin-left:-20px;padding:10px">Bài viết trong {{$category[0]->name_category}}
    </h3>
	<hr>
        ...
        <div class="col-md-30">
            ...
            <div style="width:160px;height:160px;">
                ...
                <div class=" text-2 pl-md-4">
                    ...
                    <p class="mb-4" id="content"><a href="single.html">{{$post->category->name_category}}</a> - {{$post->title2}}</p>
